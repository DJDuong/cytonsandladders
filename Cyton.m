...
%% GetCytonRobot
        ...
        L7 = Link('d',0.15,'a',0,'alpha',0,'offset', -pi/2,'qlim',[deg2rad(-150),deg2rad(150)]);
...
%         L7 = Link('d',0.07,'a',0,'alpha',0,'offset', -pi/2,'qlim',[deg2rad(-150),deg2rad(150)]);
        ...
        function PlotAndColourRobot(self)
            for linkIndex = 1:self.model.n
                [ faceData, vertexData, plyData{linkIndex + 1} ] = plyread(['cyton/Cyton',num2str(linkIndex),'.ply'],'tri'); %#ok<AGROW>
