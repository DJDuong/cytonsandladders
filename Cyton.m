...
%% GetCytonRobot
        ...
        L1 = Link('d',0.053,'a',0,'alpha',pi/2,'offset', 0,'qlim',[deg2rad(-150),deg2rad(150)]);
        L2 = Link('d',0,'a',0,'alpha',-pi/2,'offset', 0,'qlim',[deg2rad(-105),deg2rad(105)]);
        L3 = Link('d',(0.046+0.082),'a',0,'alpha',pi/2,'offset', 0,'qlim',[deg2rad(-150),deg2rad(150)]);
        ...
        L7 = Link('d',(0.125+0.03),'a',0,'alpha',0,'offset', pi,'qlim',[deg2rad(-150),deg2rad(150)]);
